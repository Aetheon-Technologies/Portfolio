    ...
    <div class="container">
        <div class="footer__inner">
            <p class="footer__copy">
                &copy; <?= date('Y') ?> <span><?= sanitize(get_setting('site_name', 'Your Name')) ?></span>. All rights reserved.
            </p>
            ...
            <div class="footer__socials">
                ...
                <a href="<?= sanitize_url(get_setting('twitter_url')) ?>" class="social-link" target="_blank" rel="noopener noreferrer" aria-label="Twitter / X">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">

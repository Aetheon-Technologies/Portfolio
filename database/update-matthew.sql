-- ============================================================
-- Portfolio: Apply Matthew McCusker's real content
-- ============================================================
-- Run this ONCE in phpMyAdmin → portfolio database → Import tab
-- This updates the live DB without touching schema or other data.
-- ============================================================
...
-- ── Blog post: replace sample post with AI Agents article ────
INSERT INTO blog_posts (title, slug, excerpt, body, read_time, tags, status, published_at)
VALUES (
